...
- ✅ مسیر ۱۱ مرحله فروش صادراتی (Inquiry تا Shipping Documents) در سیستم پیاده شود
- ✅ شرایط پرداخت بر اساس دسته محصول (۲۰/۸۰ یا ۱۰۰٪ Advance) اعمال شود
- ✅ بدون تأیید پیش‌پرداخت (SWIFT)، بارگیری/حمل شروع نشود
- ✅ پس از پرداخت کامل، مدارک حمل (B/L، Invoice، Packing List، COO، Quality) صادر شود
- ✅ سفارش فروش به تدارکات (خرید) و سپس لجستیک لینک شود
