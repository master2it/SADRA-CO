...
1. **پیاده‌سازی زنجیره تامین** بر اساس مدل SCOR: فروش → خرید → حمل → تحویل
2. **پروسیجر فروش صادراتی (۱۱ مرحله)** از Inquiry تا Shipping Documents
3. **شرایط پرداخت محصول‌محور** (۲۰/۸۰ یا ۱۰۰٪ Advance، همه T/T)
4. **راه‌اندازی CRM** — هیچ Lead از دست نرود
5. **راه‌اندازی SRM + تدارکات** — تامین از کارخانه پس از تأیید پیش‌پرداخت
6. **دستیار AI** — Quotation / PI / پاسخ اولیه؛ اپراتور تایید نهایی
7. **کاتالوگ محصولات** + سفارش تولید کارخانه‌ای
8. **لجستیک** — ۱۹ فرایند بارگیری قابل مشاهده برای ادمین، مشتری و راننده
9. **اپلیکیشن راننده** با GPS و بار برگشت
10. **UX حرفه‌ای** و **SEO قوی**
11. **معماری آماده** برای حمل دریایی/ریلی و Return
...
| سفارش‌های صادراتی با Timeline کامل | ۱۰۰٪ | ۱۱ مرحله Export Sales |
| شروع حمل فقط پس از تأیید پیش‌پرداخت | ۱۰۰٪ | `payment_confirmed` gate |
